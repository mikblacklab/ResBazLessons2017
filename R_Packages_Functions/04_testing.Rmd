...
Based on the [R-packages](http://swcarpentry.github.io/r-novice-inflammation/08-making-packages-R/) SWC lesson

http://swcarpentry.github.io/r-novice-inflammation/08-making-packages-R/

- create a new package
- create functions to convert between each of Fahrenheit, Celsius, and Kelvin
- create the documentation
- create tests for each converter